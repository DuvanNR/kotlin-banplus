...
interface VueltoRespository {
    suspend fun emitTransaction(e:iTransaction, commerce: Commerce): ApiResponseStatus<Tranferp2pResponse>
}
class VueltoRespositoryImp @Inject constructor(
    private val dataSource: ApiServer,
): VueltoRespository {
    override suspend fun emitTransaction(e: iTransaction, commerce: Commerce): ApiResponseStatus<Tranferp2pResponse> = makeNetworkCall {
