...
interface CommerceDao {
    ...
    @Query("UPDATE commerce SET razonSocial=:razonSocial,telefono=:telefono, rif=:rif, tipo=:tipo WHERE id =:id")
    fun update(razonSocial: String,telefono: String, rif: String, tipo: String, id:Int)
}